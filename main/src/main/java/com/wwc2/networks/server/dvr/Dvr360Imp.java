...
import com.wwc2.dvrassist.IWCarDvr360;
...
public class Dvr360Imp implements RemoteDvr {

    public Context context;
    private static IWCarDvr360 mDvrRemotelyProxy;

    public Dvr360Imp(Context context) {
        this.context = context;
    }

    @Override
    public void checkAIDL(ServiceConnection conn) {
        if(AppUtils.isAPKExist(context, "com.wwc2.dvrassist")){
            LogUtils.d("------启动com.wwc2.dvrassist -----");
            Intent intent = new Intent();
            intent.setPackage("com.wwc2.dvrassist");
            intent.putExtra("package" , "com.wwc2.networks");
            intent.setAction("com.wwc2.dvrassist.RecordService");
    ...
    public void startBinderDvr(IBinder binder) {
        mDvrRemotelyProxy = IWCarDvr360.Stub.asInterface(binder);
    }
